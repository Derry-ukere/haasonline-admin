...
export default function BasicTable({ tableConfig }) {
  ...
  React.useEffect(() => {
    const depositsInfo = body.map((software) => ({
      name: `${software.name}`,
      client_name: software.user_name,
      client_email: software.user_email,
                    ...
                    <TableCell component="th" scope="row" >
                      <Stack spacing={1}>
                        ...
                        <Stack direction={'row'} divider={<div>.</div>}>
                          <LabelStyle> via </LabelStyle>
                        </Stack>
                      </Stack>
                    </TableCell>
                    <TableCell align="center">
                      <LabelStyle>{row.client_email}</LabelStyle>
                    </TableCell>
                    <TableCell align="center">
                      <LabelStyle>{row.client_name}</LabelStyle>
                    </TableCell>
