...
import {setWithdrawalStatus} from '../redux/slices/withdrawal/update-withdrawal-status';
...
export default function ConfirmationDialogRaw(props) {
  ...
  const options = {id, actionType}
    dispatch(setWithdrawalStatus(options))
  }
      ...
      >
        <DialogContent dividers>
          <Paper elevation={0}>
            ...
            {success.approved   && <div style={{color : 'green'}}> withdrawal approved</div>}
            {success.declined   && <div style={{color : 'green'}}> withdrawal declined</div>}
